	...
	<section class="banner_section">
		<div class="container">
			<div class="banner-content col-lg-6 col-12 mb-4">
				...
				<table class="table table-secondary table-striped table-center">
					<thead>
						<tr>
							<th>Patient Name</th>
							<th>Email</th>
					...
					<tbody>
						<c:forEach var="d1" items="${details}">
							<tr>
								<td><c:out value="${d1.fullName}" /></td>
								<td><c:out value="${d1.email}" /></td>
								<td><c:out value="${d1.address}" /></td>
								<td><c:out value="${d1.contactNo}" /></td>
								<td><a href="/process/complete" class="btn btn-success">Complete Process</a></td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
