...
<title>View Doctor and Book appointment</title>
...
<body class="distributors">
	...
	<section class="banner_section">
		<div class="container">
			<div class="banner-content col-lg-6 col-12 mb-4">
				<h1>Doctors List</h1>
				<div class="db-list col-lg-20">
					<div class="row">
						<div class="col-sm-6">
							<div class="card">
								<div class="card-body">
									<h5 class="card-title">Dr Rohith Goud</h5>
									<p class="card-text">Experience: 15 years</p>
									<p class="card-text">Occupation: Mbbs</p>
									<a href="/add/patient" class="btn btn-success">Proceed</a>
								</div>
							</div>
						</div>
						<div class="col-sm-6">
							<div class="card">
								<div class="card-body">
									<h5 class="card-title">Dr Naveen</h5>
									<p class="card-text">Experience: 20 years</p>
									<p class="card-text">Occupation: Surgeon</p>
									<a href="/add/patient" class="btn btn-success">Proceed</a>
								</div>
							</div>
						</div>
						<div class="col-sm-6">
							<div class="card">
								<div class="card-body">
									<h5 class="card-title">Dr Jhansi Laxmi</h5>
									<p class="card-text">Experience: 25 years</p>
									<p class="card-text">Occupation: Mbbs Frcs Md</p>
									<a href="/add/patient" class="btn btn-success">Proceed</a>
								</div>
							</div>
						</div>
						<div class="col-sm-6">
							<div class="card">
								<div class="card-body">
									<h5 class="card-title">Dr Siddu</h5>
									<p class="card-text">Experience: 18 years</p>
									<p class="card-text">Occupation: General Surgeon</p>
									<a href="/add/patient" class="btn btn-success">Proceed</a>
								</div>
							</div>
						</div>
						<div class="col-sm-6">
							<div class="card">
								<div class="card-body">
									<h5 class="card-title">Dr Anu</h5>
									<p class="card-text">Experience: 13 years</p>
									<p class="card-text">Occupation: General Physician</p>
									<a href="/add/patient" class="btn btn-success">Proceed</a>
								</div>
							</div>
						</div>
						<div class="col-sm-6">
							<div class="card">
								<div class="card-body">
									<h5 class="card-title">Dr Sailaja</h5>
									<p class="card-text">Experience: 30 years</p>
									<p class="card-text">Occupation: London Return Mbbs Frcs Md</p>
									<a href="/add/patient" class="btn btn-success">Proceed</a>
								</div>
							</div>
						</div>
	...
	<section class="footer_wrapper mt-3 mt-md-0">
		...
		<div class="container-fluid copyright-section">
			<p>
				Copyright <a href="#">N.R.B Services</a> All Rights Reserved
			</p>
		</div>
	</section>
	<!-- Footer Section Exit  -->
