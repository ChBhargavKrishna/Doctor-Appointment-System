...
.banner_section .add-patient-form {
	background-color: var(--light-color);
	padding: 5rem;
	box-shadow: 0 0.2rem 1.5rem rgb(0 0 0/ 4%);
}

.banner_section .add-patient-form .form-control::placeholder {
	color: var(--primary-text);
}

.banner_section .add-patient-form .form-control {
	padding: 1rem 1.5rem;
	border-radius: 0.rem;
	...
	<section class="banner_section">
		<div class="container">
			...
			<div class="row justify-content-center">
				<form:form modelAttribute="pat" action="/view/patient" method="post">
					<div class="col-12 add-patient-form">
						<div class="row">
							<div class="col-lg-7 mb-5">
								<div class="col-md-6 mb-4">
									<img src="/doctor/add_patient.png" alt="add patient">
									<p>Please Fill Details Below</p>
								</div>
								<div class="row g-3">
									<div class="col-md-6 mb-4">
										<input name="fullName" id="fullName" pattern="[A-Za-z\\s]*"
