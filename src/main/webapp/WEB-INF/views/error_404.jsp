...
.banner_section {
	background-image: url('/bg/bg-appointment.png');
	background-repeat: no-repeat;
		...
		<div class="header">
			<div class="container">
				<nav class="navbar navbar-expand-lg">
					<a class="navbar-brand" href="/"> <img src="/LAE/logo.png"
		...
		<div class="container">
			<div class="row align-items-center flex-column flex-lg-row-reverse">
				<div class="col-lg-7 mb-5 mb-lg-0">
					<div class="">
						<img src="/bg/error_404.png">
					</div>
				</div>
				<div class="col-lg-5 pb-5 text-center text-lg-start">
					<h2 class="section-title">Opps...... This page is not found.</h2>
					<p class="text-black">Basically, Find Your Doctor And Consult
						Them and This Is not Right page what You are Finding.</p>
					<a href="/" class="btn main-btn">Back To Home</a>
				</div>
			</div>
		</div>
	</section>
