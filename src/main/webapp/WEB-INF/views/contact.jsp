...
.contact_section .content-box .info-box li {
    position: relative;
    padding-left: 7rem;
...
.contact_section .content-box .info-box li i {
    position: absolute;
    left: 0;
    top: 1.5rem;
    font-size: 4.5rem;
...
.contact_section .content-box .info-box li p {
    color: var(--primary-text);
}

.contact_section .content-box .info-box li a {
...
@media ( max-width :991px) {
	...
	.about .banner_section, .product .banner_section, .Gallery .banner_section,
		.contact_section .banner_section {
		padding-top: 12.5rem;
		padding-bottom: 3rem;
	}
}
	...
	<section class="banner_section">
		<div class="container">
			<div class="banner-content col-lg-6 col-12 mb-4">
				<h1>Contact Us</h1>
				<b><p>They Are Various To Contact With Us Like Scroll Down
						For Information And Join US in FaceBook , Twitter , YouTube,
						InstaGram And Various Social Media Platforms Kindly Check The
						Terms And Conditions</p></b>
			</div>
		</div>
	</section>
	<!-- banner section exit -->
	...
	<section class="contact_section">
		<div class="container">
			<div class="row justify-content-center">
				...
				<form:form modelAttribute="con" action="/message" method="post">
					<div class="col-12 contact-form">
						<div class="row">
							<div class="col-lg-7 mb-5">
								<div class="row g-3">
									<div class="col-md-6 mb-4">
										<input name="name" id="name" pattern="[A-Za-z\\s]*"
									...
									<div class="col-md-6 mb-4">
										<input type="tel" pattern="[0-9]*" minlength="10"
											maxlength="10" name="contactNo" placeholder="Contact Number"
											class="form-control" id="contactNo" required />
									</div>
									...
									<div class="col-12 mb-4">
										<button type="submit" class="btn main-btn">Send
											Message</button>
									</div>
								</div>
							</div>
								...
								<div class="content-box ms-sm-5">
									<ul class="info-box clearfix">
										<li><i class="fas fa-phone-alt"></i>
											...
											<div>
												<a href="#">+91 8340086668</a>
											</div></li>
										<li><i class="fas fa-envelope"></i>
											<p>Any Questions? Email us</p>
											<div>
												<a href="#">nrb@gmail.com</a>
											</div></li>
									</ul>
								</div>
							</div>
