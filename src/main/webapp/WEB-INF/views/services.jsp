...
.service-item {
	...
	/* 3 images per row with gap consideration */
	box-sizing: border-box
}
					...
					<div class="collapse navbar-collapse" id="main-nav">
						<ul class="navbar-nav mx-auto">
							...
							<li class="nav-item"><a class="nav-link active"
								href="/services"><i class="fas fa-hand-holding-medical me-3"></i>Services</a></li>
	...
	<section class="banner_section">
		<div class="container">
			<div class="banner-content">
				<h1>Services</h1>
				<b><p>This services are available 24/7 emergency services
						also provided. Professional doctors and good care of nurses and
						also kindly scroll down for our services.</p></b>
			</div>
		</div>
	</section>
	<!-- banner section exit -->
		...
		<div class="container">
			<div class="row">
				<div class="col-12 text-center pb-3">
					...
					<p class="section-subtitle">This Services are available 24/7
						support and any emergency contact us.</p>
				</div>
				<div class="service-item col-sm-5 col-lg-2 mb-4">
					<img decoding="async" src="/service/service-img1.png"
						class="img-fluid rounded-3">
					<p>Heart Problems</p>
					<p>The best team of Heart specialists and surgeons available
						24/7.</p>
				</div>
				<div class="service-item col-sm-5 col-lg-2 mb-4">
					<img decoding="async" src="/service/service-img2.png"
						class="img-fluid rounded-3">
					<p>Dental Service</p>
					<p>The best team of Dental doctors and surgeons available 24/7.</p>
				</div>
				<div class="service-item col-sm-5 col-lg-2 mb-4">
					<img decoding="async" src="/service/service-img3.png"
						class="img-fluid rounded-3">
					<p>ENT</p>
					<p>The best team of ENT doctors and surgeons available 24/7.</p>
				</div>
				<div class="service-item col-sm-5 col-lg-2 mb-4">
					<img decoding="async" src="/service/service-img4.png"
						class="img-fluid rounded-3">
					<p>CT Scan Service</p>
					<p>The best team of CT scan with best equipment doctors and
						surgeons available 24/7.</p>
				</div>
				<div class="service-item col-sm-5 col-lg-2 mb-4">
					<img decoding="async" src="/service/service-img5.png"
						class="img-fluid rounded-3">
					<p>X Ray</p>
					<p>The best team of X Ray consulted doctors and surgeons
						available 24/7.</p>
				</div>
				<div class="service-item col-sm-8 col-lg-2 mb-2">
					<img decoding="async" src="/service/service-img6.png"
						class="img-fluid rounded-3">
					<p>Orthopedic Services</p>
					<p>The best team of Orthopedics doctors and surgeons available
						24/7</p>
				</div>
			</div>
		</div>
